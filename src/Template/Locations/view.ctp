...
<?= $this->Form->postLink(__('Eliminar'), ['controller'=> 'Locations', 'action' => 'delete', $location->location_id], ['class' => 'btn btn-primary', 'confirm' => __('Seguro que desea eliminar la Ubicación: "{0}"?', $location->nombre)]) ?>
